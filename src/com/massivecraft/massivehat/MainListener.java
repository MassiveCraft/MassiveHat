...
public class MainListener implements Listener
{
	...
	public static Player getHattingPlayer(InventoryClickEvent event)
	{
		...
		// ... is clicking around in their own/armor/crafting view, or is working in creative ...
		if (event.getView().getType() != InventoryType.CRAFTING && event.getView().getType() != InventoryType.PLAYER) return null;
